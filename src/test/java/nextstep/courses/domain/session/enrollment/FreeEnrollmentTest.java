...
class FreeEnrollmentTest {
    ...
    void enroll_정상케이스() {
        Enrollment enrollment = new FreeEnrollment(Status.RECRUIT, EnrollmentStatus.POSSIBLE, students);
    ...
    void enroll_실패케이스_현재_모집중인_강의가_아닌_경우() {
        Enrollment enrollment = new FreeEnrollment(Status.RECRUIT, EnrollmentStatus.IMPOSSIBLE, students);
